    ...
    <main className="inner-page privacy-page" id="main-content">
      ...
      <section className="page-section">
        <div className="shell privacy-content">
          ...
          <article>
            <h2>Ваш вибір</h2>
            <p>Ви можете не надсилати форму, відкликати згоду щодо подальшої комунікації або відмовитися від аналітичних файлів cookie у повідомленні на сайті. Змінити вибір аналітики можна будь-коли через пункт «Налаштування cookie» у нижній частині сторінки.</p>
          </article>
          <article>
            <h2>Контакт</h2>
