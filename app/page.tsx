        ...
        <div className="shell hero-layout">
          <div className="hero-copy">
            ...
            <p className="hero-lead">
              Будуємо ангари, склади, зерносховища та інші промислові й комерційні об’єкти
              під ключ — від технічного рішення до монтажу й здачі. Також виконуємо окремі
              етапи як підрядник або субпідрядник: металоконструкції, бетонні та фасадні роботи.
              Основний регіон — Дніпро та область; масштабні проєкти — по Україні.
            </p>
