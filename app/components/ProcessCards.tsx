...
const projectSteps: readonly ProcessCard[] = [
  { number: '01', title: 'Знайомство', text: 'Уточнюємо задачу, тип об’єкта, умови та бажаний результат.', icon: Handshake },
  ...
  { number: '05', title: 'Перевірка і здача', text: 'Разом перевіряємо результат і закриваємо виконані роботи.', icon: BadgeCheck },
];

const estimateItems: readonly ProcessCard[] = [
  { number: '01', title: 'Призначення', text: 'Що планується всередині: виробництво, склад, техніка, зерно або інша задача.', icon: Factory },
