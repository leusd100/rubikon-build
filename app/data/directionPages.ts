...
export const directionPages: Record<DirectionId, DirectionPageConfig> = {
  ...
  zernoskhovyshcha: {
    ...
    overview: {
      ...
      text: 'Склад споруди визначають обсяг зберігання, схема завантаження й вивантаження, вимоги до вентиляції та умови майданчика.', layout: 'features',
      items: [
  ...
  'betonni-roboty': {
    ...
    process: {
      title: 'Контроль до заливання важливіший за виправлення після',
