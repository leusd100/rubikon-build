  ...
  metalokonstruktsii: {
    ...
    overview: {
      ...
      items: [
        ...
        ['04', 'Нестандартні вузли', 'Виготовлення деталей і з’єднань під конкретну задачу, креслення або наявні умови об’єкта.'],
      ],
    },
    process: {
    ...
    cta: { eyebrow: 'Обговорити металоконструкції', title: 'Є креслення або лише задача? Почнемо з вихідних даних' },
  },
  'betonni-roboty': {
    id: 'betonni-roboty',
    hero: {
