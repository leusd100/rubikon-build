...
There is currently **no `typecheck` or `test` script** in `package.json`. If one is added later
(e.g. `"typecheck": "tsc --noEmit"`), update this section and the CI workflow together.
